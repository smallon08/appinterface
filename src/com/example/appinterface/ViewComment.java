 ...
 /*   	try {
	...
	public void handleBlogResponse() {
		...
		if (mBlogData == null) {
			...
			try {
				JSONArray jsonPosts = mBlogData.getJSONArray("comment");
				ArrayList<HashMap<String, String>> blogPosts = 
						new ArrayList<HashMap<String, String>>();
				for (int i = 0; i < jsonPosts.length(); i++) {
					JSONObject post = jsonPosts.getJSONObject(i);
					String Date = post.getString("cdate");
					...
					String record="Date:"+Date+"		-From:"+Name;
					
					HashMap<String, String> blogPost = new HashMap<String, String>();
					blogPost.put(KEY_TITLE, Comment);
					blogPost.put(KEY_AUTHOR, record);
    ...
    private class GetBlogPostsTask extends AsyncTask<Object, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Object... arg0) {
	        ...
	        try {
	        	URL blogFeedUrl = new URL("http://54.254.179.218/json_for_comment.php");
